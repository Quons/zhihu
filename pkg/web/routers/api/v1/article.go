...
import (
	...
	"zhihu/pkg/setting"
	"zhihu/pkg/util"
	"zhihu/pkg/web/handler/article_handler"
	"zhihu/pkg/web/handler/tag_handler"
...
func GetArticle(c *gin.Context) {
	...
	articleService := article_handler.Article{ID: id}
...
func AddArticle(c *gin.Context) {
	...
	tagService := tag_handler.Tag{ID: form.TagID}
